...
public class MyRestController {
    ...
    public Employee getEmployee(@PathVariable int id) {
        ...
        if(employee == null) {
            throw new NoSuchEmployeeException("There is no employye with id = " + id + " in database");
        }
    ...
    public String deleteEmployee(@PathVariable int id) {
        Employee employee = employeeService.getEmployee(id);
        if(employee == null) {
            throw new NoSuchEmployeeException("There in no employee with id = " + id + " in database");
        }
